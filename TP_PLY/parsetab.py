...
_lr_signature = 'NUMBER PLUS MINUS TIMES DIVIDE LPAREN RPARENexpression : expression PLUS termexpression : expression MINUS termexpression : termterm : term TIMES factorterm : term DIVIDE factorterm : factorfactor : NUMBERfactor : LPAREN expression RPAREN'
...
_lr_productions = [
  ...
  ('term -> term DIVIDE factor','term',3,'p_term_div','yacc.py',23),
